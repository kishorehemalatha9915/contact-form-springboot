...
2.Run ContactformApplication.java.
3.Wait until the console shows:
   Started ContactformApplication
4.Open your browser and visit:
http://localhost:8080
5.Enter your name, email, and message.
6.Click Submit.
7.A success message will appear, and the submitted data will be displayed in the console.
...
Name:HEMALATHA.S Email: hemalatha@123.com Message: Hello, this is a test message.
